...
const { Yuta, m, text, q, prefix, command, replygcyuta, leogg, sendReaction, limituser, limitAbis, useLimit, registered, IsReg, YutaTheCreator, getBuffer } = context;
...
let leo = {
 ...
 await Yuta.sendMessage(saluran2, leo, { quoted: leogg });
sendReaction("✅")
replygcyuta(`Liat Di Ch
