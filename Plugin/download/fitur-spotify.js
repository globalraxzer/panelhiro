...
module.exports = {
type: 'download',
command: ['spotify','spotifysearch','spotifys','splay','yta','spotifydl'],
...
if (!text) return replygcyuta('.spotify <request> lagu download .splay <link>')
let hasil = await SearchSpotify(text)
let capt = `々──── *[ Spotify Search ]* ──々\n\n`
let nomor = 1
...
text: capt,
 ...
 newsletterName: `Spotify By: ${ownername}`, 
 serverMessageId: -1
},
