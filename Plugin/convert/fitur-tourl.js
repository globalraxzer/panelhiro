...
operate: async (context) => {
    const { Yuta, m, text, q, prefix, command, replygcyuta, leogg, quoted, sendReaction, limituser, limitAbis, useLimit, registered, IsReg, fetchJson, readmore, mime } = context;
